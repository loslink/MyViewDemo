...
public class MyAnimationDrawable {
        ...
        loadRaw(resourceId, imageView.getContext(),
                new OnDrawableLoadedListener() {
                    ...
                    public void onDrawableLoaded(List<MyFrame> myFrames) {
                        ...
                        if(isInfinite){//无限循环
                            animateInfinite(myFrames, imageView);
                        }else{
    ...
    private static void animateInfinite(final List<MyFrame> myFrames, final ImageView imageView){
        animateRawManually(myFrames, imageView, new Runnable() {
            @Override
            public void run() {
                imageView.setRotation(imageView.getRotation()+35);
                animateInfinite(myFrames, imageView);
            }
        });
    }

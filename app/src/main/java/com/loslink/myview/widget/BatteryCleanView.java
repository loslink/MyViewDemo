...
public class BatteryCleanView extends View {
    ...
    public BatteryCleanView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BatteryCleanView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        itemPaint.setShadowLayer(4f, 2f, 2f, Color.parseColor("#22000000"));
    ...
    public void setCleanState(BatteryState cleanState) {
    ...
    public void startAnimation() {
        ...
        if (currentCleanState == BatteryState.Checking) {
    ...
    public void startRepeatAnimation() {
        ...
        repeatAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                postInvalidate();
                if (currentCleanState == BatteryState.CheckFinish) {
                    postInvalidate();
                    repeatAnimator.cancel();
                    startAnimation();
                }
